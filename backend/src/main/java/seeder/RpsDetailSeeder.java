...
public class RpsDetailSeeder {
        ...
        public void seed(HBaseCustomClient client) throws IOException {
                ...
                seedOne(client, "RPD004-4", "4", "Minggu 4", "RPS004", "Pemrograman Berorientasi Objek", "CP MK 4",
                                "30");
                ...
                seedOne(client, "RPD009-5", "5", "Minggu 5", "RPS009", "Jaringan Komputer Dasar", "CP MK 9", "20");
                seedOne(client, "RPD010-6", "6", "Minggu 6", "RPS010", "Desain Antarmuka", "CP MK 10", "25");
                seedOne(client, "RPD011-5", "5", "Minggu 5", "RPS011", "Kecerdasan Bisnis", "CP MK 11", "20");
                seedOne(client, "RPD012-6", "6", "Minggu 6", "RPS012", "Manajemen Proyek TI", "CP MK 12", "25");
                seedOne(client, "RPD013-7", "7", "Minggu 7", "RPS013", "Keamanan Jaringan", "CP MK 13", "20");
                seedOne(client, "RPD014-8", "8", "Minggu 8", "RPS014", "Interaksi Manusia Komputer", "CP MK 14", "25");
                seedOne(client, "RPD015-7", "7", "Minggu 7", "RPS015", "Sistem Pendukung Keputusan", "CP MK 15", "20");
                seedOne(client, "RPD016-8", "8", "Minggu 8", "RPS016", "Manajemen Basis Data Bisnis", "CP MK 16", "25");
        }
