...
public class SoalUjianSeeder {
    ...
    public void seed(HBaseCustomClient client) throws IOException {
        seedPg(client, "SU001", "UTS Pemrograman Dasar", "Struktur kontrol perulangan yang benar adalah...", "10",
                "TX001", "SP001", "Teknik Informatika");
        seedMulti(client, "SU002", "UTS Pemrograman Dasar", "Pilih karakteristik algoritma yang baik", "15",
                "TX002", "SP001", "Teknik Informatika");
        ...
        seedPg(client, "SU005", "UTS Sistem Informasi", "Diagram alur proses bisnis paling tepat adalah...", "10",
                "TX101", "SP002", "Sistem Informasi Bisnis");
        seedMulti(client, "SU006", "UTS Sistem Informasi", "Pilih komponen utama dashboard bisnis", "15", "TX102",
                "SP002", "Sistem Informasi Bisnis");
        seedCocok(client, "SU007", "UTS Sistem Informasi", "Cocokkan KPI dengan definisinya", "20", "TX103",
                "SP002", "Sistem Informasi Bisnis");
        seedIsian(client, "SU008", "UTS Sistem Informasi", "Kepanjangan KPI adalah...", "5", "TX101", "1", "SP002",
                "Sistem Informasi Bisnis");
    }

    private void seedBase(HBaseCustomClient client, String id, String namaUjian, String pertanyaan, String bobot,
            String jenisSoal, String taksonomiId, String studyProgramId, String studyProgramName) throws IOException {
        ...
        client.insertRecord(TABLE_SOAL_UJIAN, id, "user", "id", "USR004");
        client.insertRecord(TABLE_SOAL_UJIAN, id, "user", "name", "Guru SMK Rowokangkung");
    ...
    private void seedPg(HBaseCustomClient client, String id, String namaUjian, String pertanyaan, String bobot,
            String taksonomiId, String studyProgramId, String studyProgramName) throws IOException {
    ...
    private void seedMulti(HBaseCustomClient client, String id, String namaUjian, String pertanyaan, String bobot,
            String taksonomiId, String studyProgramId, String studyProgramName) throws IOException {
        seedBase(client, id, namaUjian, pertanyaan, bobot, "MULTI", taksonomiId, studyProgramId, studyProgramName);
        client.insertRecord(TABLE_SOAL_UJIAN, id, "main", "opsi",
    ...
    private void seedCocok(HBaseCustomClient client, String id, String namaUjian, String pertanyaan, String bobot,
            String taksonomiId, String studyProgramId, String studyProgramName) throws IOException {
        seedBase(client, id, namaUjian, pertanyaan, bobot, "COCOK", taksonomiId, studyProgramId, studyProgramName);
    ...
    private void seedIsian(HBaseCustomClient client, String id, String namaUjian, String pertanyaan, String bobot,
            ...
            throws IOException {
        seedBase(client, id, namaUjian, pertanyaan, bobot, "ISIAN", taksonomiId, studyProgramId, studyProgramName);
